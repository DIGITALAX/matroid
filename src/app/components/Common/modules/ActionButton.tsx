...
import { ActionButtonProps } from "../types/common.types";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {loading && (
          <span
            className={`relative flex items-center justify-center rounded-full border-2 border-white border-t-transparent animate-spin ${
