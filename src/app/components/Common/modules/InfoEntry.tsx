...
const InfoEntry: FunctionComponent<{ dict: any }> = ({ dict }): JSX.Element => {
  return (
    <div className="relative w-full items-center justify-center h-fit flex flex-col gap-4">
      ...
      <div className="relative flex flex-col w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
        <div className="relative flex flex-col gap-3 w-full text-gray-900 text-base leading-relaxed">
          {dict?.resumen}
        </div>
      </div>
