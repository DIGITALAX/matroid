...
import Box from "./Box";
import { CajaProps } from "../types/create.types";
...
const Caja: FunctionComponent<CajaProps> = ({
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      <div
        className={`relative w-full sm:w-[80vw] lg:w-[50vw] bg-gradient-to-r from-offBlack via-black/70 to-offBlack rounded-lg flex flex-row gap-4 place-self-center row-start-1 pt-4 px-4 pb-10`}
      >
        <div
